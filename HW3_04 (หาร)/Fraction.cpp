...
void Fraction::dividey(Fraction frac2){
	int numerator2 = frac2.getDenominator();
	int denominator2 = frac2.getNumerator();
	int resultNum = numerator * numerator2;
	int resultDen = denominator * denominator2;
